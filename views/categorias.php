...
<body>
                ...
                <?php foreach ($categorias as $categoria): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#confirmarExclusaoModal" data-bs-id="<?= $categoria['id'] ?>">
                                Excluir
                            </button>
                        </td>
                    </tr>
    ...
    <script>
        // Configura o modal para passar o ID da categoria a ser excluída
        ...
        confirmarExclusaoModal.addEventListener('show.bs.modal', function (event) {
            ...
            const id = button.getAttribute('data-bs-id'); // Extrai o ID da categoria
            const btnConfirmarExclusao = document.getElementById('btnConfirmarExclusao');

            // Atualiza o link de exclusão com o ID da categoria
            btnConfirmarExclusao.href = `../controllers/excluir_categoria.php?id=${id}`;
        });
    </script>
</body>
</html>